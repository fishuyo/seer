...
compiler as module
what is a module?
has runtime module api, lifetime events...
common events init start stop restart?
module specific events...
how do we subscribe to module specific events...

```
val c = new RuntimeCompiler()

val config = CompilerConfig()
config.sourceDir += cwd()/"scripts"
c.init(config)
```
