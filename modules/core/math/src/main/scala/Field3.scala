...
object VecField3 {
  ...
  def setBoundary(f:VecField3) = {
    ...
    f(0,0,0) = (f(1,0,0)+f(0,1,0)+f(0,0,1)) * -0.333333f;
    f(f.nx-1,0,0) = (f(f.nx-2,0,0)+f(0,1,0)+f(0,0,1)) * -0.333333f;
    f(0,f.ny-1,0) = (f(1,f.ny-1,0)+f(0,f.ny-2,0)+f(0,f.ny-1,1)) * -0.333333f;
    f(0,0,f.nz-1) = (f(1,0,f.nz-1)+f(0,1,f.nz-1)+f(0,0,f.nz-2)) * -0.333333f;
    f(f.nx-1,f.ny-1,0) = (f(f.nx-2,f.ny-1,0)+f(f.nx-1,f.ny-2,0)+f(f.nx-1,f.ny-1,1)) * -0.333333f;
    f(0,f.ny-1,f.nz-1) = (f(1,f.ny-1,f.nz-1)+f(0,f.ny-2,f.nz-1)+f(0,f.ny-1,f.nz-2)) * -0.333333f;
    f(f.nx-1,0,f.nz-1) = (f(f.nx-2,0,f.nz-1)+f(f.nx-1,1,f.nz-1)+f(f.nx-1,0,f.nz-2)) * -0.333333f;
    f(f.nx-1,f.ny-1,f.nz-1) = (f(f.nx-2,f.ny-1,f.nz-1)+f(f.nx-1,f.ny-2,f.nz-1)+f(f.nx-1,f.ny-1,f.nz-2)) * -0.333333f;
  }
  ...
  def diffuse(f:VecField3) = {
    ...
    for (z <- 1 until f.nz-1; y <- 1 until f.ny-1 ; x <- 1 until f.nx-1 ){
      var fxyz = f(x,y,z)
      tmp(x,y,z) = fxyz + (fxyz * -6f + f(x+1,y,z) + f(x-1,y,z) + f(x,y+1,z) + f(x,y-1,z) + f(x,y,z+1) + f(x,y,z-1)) * a
    }
  ...
  def linearSolve(f0:VecField3, a:Float, a2:Float, itr:Int) = {
    ...
    cfor(0)(_ < itr, _ + 1){ i =>
      ...
      cfor(1)(_ < f0.ny-1, _ + 1){ y => //     j <- 1 until f0.ny-1 ) {
      cfor(1)(_ < f0.nx-1, _ + 1){ x => //i <- 1 until f0.nx-1;
        f(x,y,z) = ( f0(x,y,z) + (f(x-1,y,z) + f(x+1,y,z) + f(x,y-1,z) + f(x,y+1,z) + f(x,y,z+1) + f(x,y,z-1))*a ) * a2;
      }}}
      setBoundary(f);
    }
    f0.set( f )
